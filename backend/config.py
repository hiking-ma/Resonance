...
FEISHU_RESONANCE_HOUR = 14
FEISHU_RESONANCE_MIN = 30
# 开盘前：先补拉 T-1 份额/情绪，再生成当日执行计划
FEISHU_PLAN_PREFETCH_HOUR = 8
FEISHU_PLAN_PREFETCH_MIN = 0
FEISHU_NOTIFY_HOUR = 8
FEISHU_NOTIFY_MIN = 30
# 510300 择时 → 永续组合全仓买卖提醒
